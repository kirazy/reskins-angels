...
local function get_color_mask_working_visualisation(is_flipped)
	...
	local working_vis = {
		...
		animation = {
			layers = {
				util.sprite_load(
					"__reskins-angels__/graphics/entity/smelting/casting-machine/casting-machine-mask" .. flipped,
					{
						priority = "high",
						frame_count = 49,
						animation_speed = 0.5,
				...
				util.sprite_load(
					"__reskins-angels__/graphics/entity/smelting/casting-machine/casting-machine-highlights" .. flipped,
					{
						priority = "high",
						frame_count = 49,
						animation_speed = 0.5,
