...
if reskins.lib.settings.get_value("reskins-bobs-do-bobelectronics-circuit-style") == "off" and reskins.lib.settings.get_value("reskins-compatibility-do-circuitprocessing-circuit-style") == "off" then
	return
end
