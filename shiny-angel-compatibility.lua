...
-- When compatibility with ShinyAngelGFX is finally dropped, the contents of this file will be moved to data.lua
...
-- require("prototypes.entity.refining.electro-whinning-cell")
...
-- require("prototypes.entity.refining.ore-floatation-cell")
...
require("prototypes.entity.refining.pipes")
